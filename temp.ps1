$file1 = 'C:\Scripts\LiveAudit.xlsx' # source's fullpath 
$file2 = 'C:\Scripts\Book2.xlsx' # destination's fullpath 
...
$sheetToCopy = $wb2.sheets.item('Computers') # source sheet to copy 
